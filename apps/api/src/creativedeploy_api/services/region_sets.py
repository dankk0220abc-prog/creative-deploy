...
class RegionSetService:
    ...
    def _current_image_set(
        ...
        *,
        ...
        return resolve_current_image_set(
            project_id=project_id,
            assets=assets,
            readiness_reviews=readiness_reviews,
    ...
    def _effective_lifecycle(
        ...
        *,
        ...
        return effective_region_set_lifecycle(
            region_set,
    ...
    def _stale_reasons(
        ...
        return region_set_stale_reasons(region_set, current_image_set)
